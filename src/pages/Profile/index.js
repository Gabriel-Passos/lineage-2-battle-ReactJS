        ...
        <section className="container-profile">
          <aside className="container-aside-profile">
            ...
            <div className="aside-bottom">
              ...
              <h2>Characters</h2>
              <Link to="/profile/footer"id="btnPerson" >Personagens</Link>
              <Link to="/profile/test" id="btnUnlockChar" >Destravar char</Link>
          ...
          <section className="container-section-profile">
            ...
            <div className="content-profile">
                <Route path="/profile/footer" render={() => (
                  <Footer />
                )} />
                <Route path="/profile/test" render={() => (
                  <Test />
                )} />
            </div>
